...
<body>
	...
	<div class="container">
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				$cek = mysqli_query($con, "SELECT * FROM clientes WHERE rut = '$rut'");
					if(mysqli_num_rows($cek) == 0){
						$sql = "INSERT INTO clientes (nombre, rut, habilitado) 
								 VALUES('$nombre',$rut,$habilitado)";
						$insert = mysqli_query($con, $sql) or die(mysqli_error());
						if($insert){
							echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Cliente creado !</div>';
						}else{
							echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Error al grabar el nuevo cliente !</div>';
						}
					 
				}else{
					echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>¡ Ya existe cliente con rut: '.$rut.' !</div>';
				}
			}
			?>
	...
	<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="add_cliente.php" id="cambioclave" name="cambioclave">
