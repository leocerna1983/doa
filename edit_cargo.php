...
<body>
	...
	<div class="container">
		<div class="content">
			...
			<h2>Editar datos de Cargo</h2>
			<hr />

			<?php
			// escaping, additionally removing everything that could be (html/javascript-) code
			$id = mysqli_real_escape_string($con,(strip_tags($_GET["id"],ENT_QUOTES)));
			$consulta = "SELECT nombre, habilitado FROM cargo WHERE idcargo='$id'";
			...
			if(isset($_POST['save'])){
				...
				$sqlstr = "UPDATE cargo SET nombre ='$nombre', habilitado = ".$habilitado." where idcargo = ".$id;  
				$update = mysqli_query($con,$sqlstr) or die(mysqli_error());
				if($update){
					//echo "Habilitado ".$habilitado." Id: ".$id." ".$sqlstr;
					//header("Location: edit_categoria.php?id=".$id."&pesan=sukses");
					
					echo "<script language='javascript'>window.location='edit_cargo.php?id=".$id."&pesan=sukses'</script>"; 
				}else{
	...
	<div class="modal fade" id="ModalEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
			...
			<form class="form-horizontal" method="POST" action="edit_cargo.php" id="cambioclave" name="cambioclave">
	...
	function CambiarClave(vIdUsuario)
		...
		$("#cambioclave").submit(function(e){
			...
			header("Location: .$url.edit_cargo.php");
	    });
